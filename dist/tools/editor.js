...
export function registerEditorTools(server) {
    server.tool("rewrite_text", "Rewrite text using a voice profile or general writing rules.", {
    ...
    server.tool("humanize_text", "Apply LLM rewrite and BERT replacements to reduce AI detection signals in text.", {
    ...
    server.tool("check_ai_content", "Check whether text is likely AI-generated. Returns a score and analysis.", {
